sap.ui.define([
	...
	return BaseObject.extend("saplike.saplike.model.GroupSortState", {
		 ...
		 * @alias saplike.saplike.model.GroupSortState
		 */
		...
		/**
		 * Sorts by CustomerName, or by TotalSum
		 *
		...
		/**
		 * Groups by TotalSum, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "TotalSum") {
				...
				this._oViewModel.setProperty("/sortBy", "TotalSum");

				aSorters.push(
					new Sorter("TotalSum", false,
