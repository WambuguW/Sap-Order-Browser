sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("saplike/saplike/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("saplike.saplike.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["saplike/saplike/localService/mockserver"], function (mockserver) {
