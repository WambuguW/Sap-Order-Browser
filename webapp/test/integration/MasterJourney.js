...
sap.ui.define([
	...
	opaTest("MasterList Filtering on TotalSum less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<TotalSum>").
			and.iSelectListItemInViewSettingsDialog("<100 <Tax>").
	...
	opaTest("MasterList Filtering on TotalSum more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <Tax>").
			and.iPressOKInViewSelectionDialog();
