/*global history */
sap.ui.define([
		"saplike/saplike/controller/BaseController",
		...
		"sap/ui/Device",
		"saplike/saplike/model/formatter",
		"saplike/saplike/model/grouper",
		...
		return BaseController.extend("saplike.saplike.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("saplike.saplike.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("TotalSum", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("TotalSum", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var sObjectId = mParams.firstListitem.getBindingContext().getProperty("SalesOrderKey");
			...
			_showDetail : function (oItem) {
				...
				this.getRouter().navTo("object", {
					objectId : oItem.getBindingContext().getProperty("SalesOrderKey")
				}, bReplace);
			},
