sap.ui.define([
		...
		return BaseObject.extend("saplike.saplike.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias saplike.saplike.model.ListSelector
			 */
			 ...
			 * @return {saplike.saplike.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
